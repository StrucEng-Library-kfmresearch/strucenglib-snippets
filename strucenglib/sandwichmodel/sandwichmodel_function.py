...
def Sandwichmodel(inp):
    ...
    """
    [i, mx, my, mxy, vx, vy, v0, nx, ny, nxy, h, d_strich_bot, d_strich_top, fc_k, theta_grad_kern, fs_d, alpha_bot,
     alpha_top, beta_bot, beta_top, Mindestbewehrung, Druckzoneniteration, Schubnachweis, code, xyz, ex, ey, ez] = inp
    # code = ini.code
    ...
    while cc[0] == 1 or cc[1] == 1:
        ...
        while ii < 2:
            ...
            s_xi = s_x_stern * mH.sin(psi[ii]) + s_y_stern * mH.cos(psi[ii]) * mH.cot(
                psi[ii]) - 2 * s_xy_stern * mH.cos(psi[ii])
    ...
    return [i, as_xi, as_eta, as_z, fall, cc, t, k, psi, m_shear_c, m_cc, m_c_total,
            [xyz, ex, ey, ez, e_xi_bot, e_xi_top, e_eta_bot, e_eta_top], inp]
