...
# ------------------------------------------------------------------------------
# ------------------------------------------------------------------------------
mdl.analyse_and_extract(software='ansys_sel', fields=[ 'u', 'sf', 's' ], lstep = ['step_2','step_3','step_4']) 
...
rhino.plot_principal_stresses(mdl, step='step_3', shell_layer='top', scale=10**2)
rhino.plot_principal_stresses(mdl, step='step_3', shell_layer='bot', scale=10**2)
