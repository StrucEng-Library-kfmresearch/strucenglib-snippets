...
rhino.plot_principal_strains(mdl, step='step_3', shell_layer='top', cbar_size=0.5, scale=10**8, numeric='no', values='3') # Hauptverzerrungen 3 top (Resultate: Gauspunkte)
rhino.plot_principal_strains(mdl, step='step_3', shell_layer='top', cbar_size=0.5, scale=10**8, numeric='no', values='1') # Hauptverzerrungen 1 top (Resultate: Gauspunkte)
rhino.plot_principal_strains(mdl, step='step_3', shell_layer='bot', cbar_size=0.5, scale=10**8, numeric='no', values='3') # Hauptverzerrungen 3 bot (Resultate: Gauspunkte)
rhino.plot_principal_strains(mdl, step='step_3', shell_layer='bot', cbar_size=0.5, scale=10**8, numeric='no', values='1') # Hauptverzerrungen 1 bot (Resultate: Gauspunkte)
